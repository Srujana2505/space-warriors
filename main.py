...
FPS = 60 #how many frames per second we want the frame to update per second
...
def draw_window(red, yellow, red_bullets, yellow_bullets, red_health, yellow_health):
	...
	#when we make changes we need to manually update the display using the below line
...
#below line makes sure that we can run the main function only when running this file directly and not importing this file into another file
